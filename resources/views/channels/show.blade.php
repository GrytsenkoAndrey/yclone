                        ...
                        <form id="update-channel-form" action="{{ route('channels.update', $channel->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="channel-avatar">
                                    <div class="channel-avatar-overlay" onclick="document.querySelector('#image').click();">
                            ...
                            <input onchange="document.querySelector('#update-channel-form').submit();" type="file" name="image" class="form-control" id="image" style="display:none;">

                            <div class="form-group">
                                <label for="name" class="form-control-label">Name</label>
                                <input type="text" name="name" id="name" required class="form-control" value="{{ $channel->name }}">
                            </div>
                            <div class="form-group">
